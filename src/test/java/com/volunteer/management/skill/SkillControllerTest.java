...
class SkillControllerTest extends IntegrationTestBase {
        ...
        void adminCanCreateAndDeleteSkill() throws Exception {
                ...
                String skillName = "Driving-" + System.nanoTime();
                ...
                String skillId = objectMapper.readTree(createResult.getResponse().getContentAsString()).get("id")
                                .asText();
        ...
        void nonAdminCannotCreateSkill() throws Exception {
                ...
                String skillName = "Teaching-" + System.nanoTime();
